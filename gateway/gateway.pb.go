...
type ConnDevRequest struct {
	...
	IpDevId       string `protobuf:"bytes,2,opt,name=ipDevId,proto3" json:"ipDevId,omitempty"`
...
func (x *ConnDevRequest) GetIpDevId() string {
	if x != nil {
		return x.IpDevId
	}
	return ""
...
var file_gateway_gateway_proto_rawDesc = []byte{
	...
	0x76, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x69, 0x70, 0x44, 0x65, 0x76,
